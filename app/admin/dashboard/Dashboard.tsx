      ...
      <div className="my-4 stats inline-grid md:flex shadow stats-vertical md:stats-horizontal">
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/orders">Visualizar vendas</Link>
          </div>
        </div>
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/orders">Visualizar pedidos</Link>
          </div>
        </div>
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/products">Visualizar produtos</Link>
          </div>
        </div>
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/users">Visualizar usuários</Link>
          </div>
        </div>
      </div>
