      ...
      <div className="flex items-stretch">
        <ul className="flex items-stretch">
          <i className="btn btn-ghost ">
            {mounted && (
              <label className="swap swap-rotate pb-3">
                ...
                {/* ícone do sol */}
                <svg
                  className="swap-on fill-current w-6 h-6 mt-3 mr-1"
                ...
                {/* ícone da lua */}
                <svg
                  className="swap-off fill-current w-6 h-6 mt-3 mr-1"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
